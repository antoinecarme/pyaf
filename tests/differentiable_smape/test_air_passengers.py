...
lEngine.mOptions.mModelSelection_Criterion = "DiffSMAPE";
lEngine.mOptions.mCycle_Criterion = "DiffSMAPE";
...
lEngine.standardPlots(name = "outputs/my_airline_passengers_diff_smape_")
