...
for k in range(1,32):
    df[b1.mTimeVar + "_" + str(k) + '_Weekly'] = pd.date_range('2000-1-1', periods=df.shape[0], freq= str(k) + 'W')
    ...
    df[b1.mTimeVar + "_" + str(k) + '_PerSecond'] = pd.date_range('2000-1-1', periods=df.shape[0], freq=str(k) + 's')
...
for k in range(1,32):
    for timevar in [b1.mTimeVar +  "_" + str(k) + '_Weekly', b1.mTimeVar +  "_" + str(k) + '_Daily',
                    b1.mTimeVar +  "_" + str(k) + '_Hourly', b1.mTimeVar +  "_" + str(k) + '_PerMinute',
                    b1.mTimeVar +  "_" + str(k) + '_PerSecond']:
